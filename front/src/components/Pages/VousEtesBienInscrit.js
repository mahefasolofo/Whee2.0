      ...
      <div id="Felicitation" className="modal">
        ...
        <div className="modal-content animate card">
          <div>
            ...
            <span onClick={closeFelicitation} className="close" title="Fermer">
          ...
          <div className="container text-center">
            ...
            <p>
              Grâce à la première plateforme de covoiturage mettant en relation
              les personnes ayant des centres d'intérêt communs, faites de
