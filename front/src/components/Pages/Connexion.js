...
const Connexion = () => { // const { setAuth } = useContext(AuthContext);
            ...
            <div id="id01" className="modal">
                ...
                <form className="modal-content animate card"
                    ...
                    <div className="container"
                        ...
                        <input type="password" id="inputPassword" placeholder="Mot de passe" name="psw"
                            onChange={
                        ...
                        <div className="hs0 mQ8 un8 C9i TB_">
                            <button aria-label="" className="noButtonStyles active" data-test-id="login-signup-toggle" type="button"
                                style={
                                    {
                                        background: "none",
                                        border: "none",
