...
>>>>>>> 54472608a543b5646ffbaea6df74c8d033888c6e
    );
  };
  const continuer = () => {
    window.location.reload(false);
  ...
  return (
    <div>
      ...
      {/* Hello world */}
      <div
        className="modal fade modalCongrats"
        id="myModalCongrats"
        onClick={continuer}
      >
        <div className="modal-dialog">
          <div className="card">
            ...
            <div className="card-body text-center">
              ...
              <h4>Bienvenue</h4>
              <p>Dites Whee à la vieee Joel Andria</p>{" "}
              <button
                className="btn btn-out btn-square continue buttonInscription"
                style={{ zIndex: 30000 }}
                onClick={continuer}
                enable
              >
          ...
          <div className="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            >
              ...
              <div className="card cardInscription" data-step="">
                ...
                <h5
                  className="cardInscription-title text-center pb-0 genreTitle"
                  style={{ marginTop: 30 }}
                >
                  Vous êtes identifié en tant que:
                </h5>
              ...
              >
                ...
                <div
                  className="container containereInscritpion"
                  style={{
                    alignItems: "start",
                    marginLeft: 5,
                  }}
                  ...
                  {interet.map((val, key) => {
                    return (
                      <div
                        ...
                        style={{
                          backgroundImage:
                            'url("images/interests/' + val.img + '.png")',
                          backgroundSize: "100% 105%",
                        }}
                        key={val.id}
                      >
